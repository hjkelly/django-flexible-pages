...
# Where's the first-level project directory, where this file resides?
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_ROOT, 'mock.sqlite3'),
        'USER': '',
        'PASSWORD': '',
        'HOST': '',
        'PORT': '',
...
SECRET_KEY = 'l690xjnt(y7m_!fh#(85y7xm*hqkjj2*ieyt&2+56f5(z0a-#h'
